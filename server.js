...
app.get('/api/matchmaker/stats-by-matchmaker', protect, restrictTo('admin', 'staff', 'matchmaker'), matchmakerController.getMatchmakingStatsByMatchmaker);
app.get('/api/matchmaker/:matchmaker_username/pairings', protect, restrictTo('admin', 'staff', 'matchmaker'), matchmakerController.getMatchmakerPairings);
